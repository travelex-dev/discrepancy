(function (namespace, $) {
	...
	p._initSparklines = function () {
		...
		var points = [2, 4, 3, 5, 2, 3, 4, 5, 3, 4, 18, 5, 4, 2, 3, 4, 5];
		...
		var data = [
			{
				label: 'Completed',
				data: [
					[moment().subtract(8, 'hours').valueOf(), 50],
					[moment().subtract(7, 'hours').valueOf(), 620],
					[moment().subtract(6, 'hours').valueOf(), 380],
					[moment().subtract(5, 'hours').valueOf(), 880],
					[moment().subtract(4, 'hours').valueOf(), 450],
					[moment().subtract(3, 'hours').valueOf(), 460],
					[moment().subtract(2, 'hours').valueOf(), 200],
					[moment().subtract(1, 'hours').valueOf(), 300],
					[moment().valueOf(), 20]
				],
				last: true
			},
			{
				...
				data: [
					[moment().subtract(8, 'hours').valueOf(), 50],
					[moment().subtract(7, 'hours').valueOf(), 520],
					[moment().subtract(6, 'hours').valueOf(), 200],
					[moment().subtract(5, 'hours').valueOf(), 500],
					[moment().subtract(4, 'hours').valueOf(), 350],
					[moment().subtract(3, 'hours').valueOf(), 250],
					[moment().subtract(2, 'hours').valueOf(), 50],
					[moment().subtract(1, 'hours').valueOf(), 0],
					[moment().valueOf(), 0]
				],
				last: true
			}
		...
		chart.bind("plothover", function (event, pos, item) {
			if (item) {
				if (previousPoint !== item.dataIndex) {
					...
					var tipContent = Math.round(y) + " " + item.series.label.toLowerCase() + " between " + moment(x).subtract(1, 'hours').format('hh:mm') + " - " + moment(x).format('hh:mm');
