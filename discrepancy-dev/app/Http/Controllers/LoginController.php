...
class LoginController extends Controller 
{
	...
	public function doLogin(){
	    ...
	    $rules = array(										// Creating validation rules for the rules
	        'username'    	=> 'required|min:4|max:20', 	// make sure the username field is not empty, and has to be greater than four characters and less than 20 characters
	    ...
	    if ($validator->fails()) {	
	    						// if the validation fails, redirect to login page
	        return Redirect::to('/')
	...
	public function doLogout(){
	    ...
	    return Redirect::to('pages/login'); // redirect the user to the login screen
	}
